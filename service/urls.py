...
from . import views
from . views import ServiceHome, CompressorDetail
...
urlpatterns = [
    ...
    path('compressor/<int:id>/history_request/<int:id_post>', views.history_request_post, name='history_request_post'),
    path('compressor/<int:id>/history_request/<id_post>/shut',views.request_shut, name='request_shut'),
    #path('compressor/<int:id>/history_request/<int:id_post>/shut', RequestShut.as_view(), name='request_shut'),
